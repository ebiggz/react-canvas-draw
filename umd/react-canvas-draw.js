/*!
 * react-canvas-draw v1.2.2-ebiggz - https://embiem.github.io/react-canvas-draw/
 * MIT Licensed
 */
...
var src_CanvasDraw = /*#__PURE__*/function (_PureComponent) {
  ...
  function CanvasDraw(props) {
    ...
    src_defineProperty(_assertThisInitialized(_this), "loadSaveData", function (saveData, immediate, emitChangeEvent) {
      if (immediate === void 0) {
        immediate = _this.props.immediateLoading;
      }

      if (emitChangeEvent === void 0) {
    ...
    src_defineProperty(_assertThisInitialized(_this), "simulateDrawingLines", function (_ref) {
      var lines = _ref.lines,
          ...
          emitChangeEvent = _ref.emitChangeEvent;
    ...
    src_defineProperty(_assertThisInitialized(_this), "saveLine", function (_temp) {
      var _ref3 = _temp === void 0 ? {} : _temp,
          ...
          emitChangeEvent = _ref3.emitChangeEvent;
